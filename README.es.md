...
### Método 1: Instalación directa mediante URL (Recomendado)
...
Este proyecto está distribuido bajo los términos de la licencia GNU General Public License v3.0 (GPLv3). Consulte el archivo [LICENSE](LICENSE) para más información.
